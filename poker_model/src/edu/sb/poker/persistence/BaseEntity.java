...
import edu.sb.poker.util.XmlLongToStringAdapter;
 ...
 */
@Entity
@Table(schema = "poker", name = "BaseEntity", indexes = @Index(columnList = "discriminator"))
@Inheritance(strategy = JOINED)
@DiscriminatorColumn(name = "discriminator")
@JsonbVisibility(JsonProtectedPropertyStrategy.class)
@XmlType @XmlAccessorType(NONE) @XmlSeeAlso({ Document.class, Person.class, PokerTable.class, Card.class, Game.class, Hand.class})
